...
const PRODUCTOS = [
    //Comienza carga de productos
        {
            ...
            Img: "../assets/imgs/productos/auris/cloudcore.jpg",
            tipo:"auris",
            precio:12500,
            cantidad:1,
            desc: "asda",
            carrito:`<svg class="aurisAddToCart" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-cart-plus-fill" viewBox="0 0 16 16">
    ...
    
        {
            ...
            Img: "../assets/imgs/productos/auris/cloudii.jpg",
            tipo: "auris",
            precio:14000,
            cantidad:1,
            desc: "sad",
    ...
    
        {
            ...
            Img: "../assets/imgs/productos/auris/cloudalpha.jpg",
            tipo: "auris",
            precio: 12000,
            cantidad: 1,
            desc: "asasd",
    ...
    
        {
            ...
            Img: "../assets/imgs/productos/auris/cloudflights.jpg",
            tipo: "auris",
            precio: 12500,
            cantidad: 1,
            desc: "ads",
    ...
    
        {
            ...
            Img: "../assets/imgs/productos/auris/gprowireless.jpg",
            tipo: "auris",
            precio: 20000,
            cantidad:1,
            desc: "asd",
    ...
    
        {
            ...
            Img: "../assets/imgs/productos/auris/g435.jpg",
            tipo: "auris",
            precio: 15500,
            cantidad:1,
            desc: "asda",
    ...
    
        {
            ...
            Img: "../assets/imgs/productos/auris/g333.jpg" ,
            tipo: "auris",
            precio:8500,
            cantidad:1,
            desc: "asda",
    ...
    
        {
            ...
            Img: "../assets/imgs/productos/auris/earbuds.jpg",
            tipo: "auris",
            precio: 8000,
            cantidad:1,
            desc: "asda",
    ...
    //Cambio de tipo de producto
    
        {
            ...
            Img: "../assets/imgs/productos/celus/ipad.jpg",
            tipo: "cels",
            precio: 60500,
            cantidad:1,
            desc: "dsa",
    ...
    
        {
            ...
            Img: "../assets/imgs/productos/celus/ipadair.jpg",
            tipo:"cels",
            precio: 169000,
            desc: "asds",
            carrito: `<svg class="aurisAddToCart" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-cart-plus-fill" viewBox="0 0 16 16">
    ...
    
        {
            ...
            Img: "../assets/imgs/productos/celus/iphoneonce.jpg",
            tipo:"cels",
            precio: 120000,
            cantidad:1,
            desc: "asdsa",
    ...
    
        {
            ...
            Img: "../assets/imgs/productos/celus/s22.jpg" ,
            tipo: "cels",
            precio:206500,
            desc: "asd",
            cantidad:1,
    ...
    
        {
            id: 14,
            nombre: "Samsung S21",
            Img: "../assets/imgs/productos/celus/s21.jpg",
            tipo: "cels",
            precio: 169000,
            desc: "sdsad",
            cantidad:1,
    ...
    
        {
            id: 15,
            nombre: "Xiaomi 11",
            Img: "../assets/imgs/productos/celus/xiaomi11.jpg",
            tipo: "cels",
            precio: 120000,
            desc: "sad",
            cantidad:1,
...
const mostrarCarrito = () => {
    const contenedorCarrito = document.getElementsByClassName("contentContainer");
    ...
    CARRITO.forEach((prod) =>{
        ...
        div.innerHTML = `   
                            <div>
                                <img class = "cartImg" src = ${prod.Img}>
                            </div>
                            <div> 
                                <P> ${prod.nombre}</P>
                            </div> 
