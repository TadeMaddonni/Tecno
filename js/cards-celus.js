// Obtención de "la base de datos" del archivo JSON
const getData = async () => {
...
// Creacion de la funcion para renderizar las cards
const mostrarProductos =  async () => {

    // Captura del elemento padre
    const container = document.querySelector("#sectionProductos");
    
    // Creación del array de objetos a partir de la data recibida
    const productos =  await getData();

    // Filtrado de los elementos para la obtención de cels
    const celus = productos.filter(product => product.tipo == "cels")

    //Renderizado en el DOM de las cards correspondientes
    celus.forEach(producto => {
...
// Llamada a la funcion de renderizado al cargar la página
